...
namespace MicroPipes.Reflection
{
    public class QualifiedIdentifier : IEquatable<QualifiedIdentifier>, IComparable<QualifiedIdentifier>, IComparable
    {
        ...
        public QualifiedIdentifier([NotNull] Identifier name, [NotNull] params Identifier[] nameSpace)
        {
            ...
            Names = nameSpace.Union(new [] {name}).ToArray();
        }
        ...
        public static implicit operator QualifiedIdentifier(string id) => Parse(id);
        public static implicit operator QualifiedIdentifier(Identifier id) => new QualifiedIdentifier(id);
